...
public class Camera1Control implements com.baidu.ocr.ui.camera.ICameraControl {
    ...
    private com.baidu.ocr.ui.camera.PermissionCallback permissionCallback;
    ...
    @Override
    public void setDisplayOrientation(@com.baidu.ocr.ui.camera.CameraView.Orientation int displayOrientation) {
        this.displayOrientation = displayOrientation;
        switch (displayOrientation) {
            case com.baidu.ocr.ui.camera.CameraView.ORIENTATION_PORTRAIT:
                rotation = 90;
                break;
            case com.baidu.ocr.ui.camera.CameraView.ORIENTATION_HORIZONTAL:
                rotation = 0;
                break;
            case com.baidu.ocr.ui.camera.CameraView.ORIENTATION_INVERT:
                rotation = 180;
                break;
            default:
                rotation = 0;
    ...
    public void takePicture(final OnTakePictureCallback onTakePictureCallback) {
        ...
        try {
            ...
            cancelAutoFocus();
            com.baidu.ocr.ui.camera.CameraThreadPool.execute(new Runnable() {
                @Override
                public void run() {
    ...
    @Override
    public void setPermissionCallback(com.baidu.ocr.ui.camera.PermissionCallback callback) {
    ...
    private void cancelAutoFocus() {
        ...
        com.baidu.ocr.ui.camera.CameraThreadPool.cancelAutoFocusTimer();
    }

    private void startAutoFocus() {
        com.baidu.ocr.ui.camera.CameraThreadPool.createAutoFocusTimerTask(new Runnable() {
            @Override
            public void run() {
    ...
    private void updateFlashMode(int flashMode) {
        switch (flashMode) {
            ...
            case FLASH_MODE_OFF:
                ...
                break;
            case com.baidu.ocr.ui.camera.ICameraControl.FLASH_MODE_AUTO:
    ...
    private int getSurfaceOrientation() {
        @com.baidu.ocr.ui.camera.CameraView.Orientation
